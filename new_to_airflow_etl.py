...
# Simple airflow DAG
# Hit a public API end point, save the file locally
# Push the local file to a S3 bucket and then load the file into a snowflake table
# You can run the code. Remember to define your AWS S3 and Snowflake connections.
